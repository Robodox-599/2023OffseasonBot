...
public class cGroup_Elevator{
  // public static Command scoreHighCone(subsystem_Elevator elevator){
  ...
  public static Command scoreMidCone(subsystem_Elevator elevator){
      SmartDashboard.putBoolean("commandSequenced", true);
    return Commands.sequence(
  ...
  // public static Command scoreHighCube(subsystem_Elevator elevator){
  //   return Commands.sequence(
  ...
  // public static Command scoreMidCube(subsystem_Elevator elevator){
  //   return Commands.sequence(
  ...
  // public static Command scoreHybrid(subsystem_Elevator elevator){
  //   return Commands.sequence(
