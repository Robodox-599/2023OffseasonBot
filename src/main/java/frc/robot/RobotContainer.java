...
public class RobotContainer {
  ...
  private final subsystem_Elevator s_Elevator = new subsystem_Elevator();
   ...
   public RobotContainer() {
    SmartDashboard.putBoolean("commandSequenced", false);
  ...
  private void configureButtonBindings() {
    ...
    midCone.onTrue(cGroup_Elevator.scoreMidCone(s_Elevator));
  ...
  public Command getAutonomousCommand() {
    ...
    return null; //help idkKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK 
  }
}
