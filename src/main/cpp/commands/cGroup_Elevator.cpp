...
// Teleop Commands
  frc2::CommandPtr ElevatorMovements::ScoreHighCone(subsystem_Elevator* Elevator, subsystem_Wrist* Wrist, subsystem_Intake* Intake, subsystem_LED* LED){
    return frc2::cmd::Sequence(command_MoveElevator(Elevator, [=]{return ElevatorConstants::kElevatorScoreHighCone;}, [=]{return false;}, [=]{return ElevatorConstants::ElevatorThreshold;}).ToPtr(),
  ...
  frc2::CommandPtr ElevatorMovements::ScoreMidCone(subsystem_Elevator* Elevator, subsystem_Wrist* Wrist, subsystem_Intake* Intake, subsystem_LED* LED){
    return frc2::cmd::Sequence(command_MoveElevator(Elevator, [=]{return ElevatorConstants::kElevatorScoreMidCone;}, [=]{return false;}, [=]{return ElevatorConstants::ElevatorThreshold;}).ToPtr(),
  ...
  frc2::CommandPtr ElevatorMovements::ScoreHighCube(subsystem_Elevator* Elevator, subsystem_Wrist* Wrist, subsystem_Intake* Intake, subsystem_LED* LED){
    return frc2::cmd::Sequence(command_MoveElevator(Elevator, [=]{return ElevatorConstants::kElevatorScoreHighCube;}, [=]{return false;}, [=]{return ElevatorConstants::ElevatorThreshold;}).ToPtr(),
  ...
  frc2::CommandPtr ElevatorMovements::ScoreMidCube(subsystem_Elevator* Elevator, subsystem_Wrist* Wrist, subsystem_Intake* Intake, subsystem_LED* LED){
    return frc2::cmd::Sequence(command_MoveElevator(Elevator, [=]{return ElevatorConstants::kElevatorScoreMidCube;}, [=]{return false;}, [=]{return ElevatorConstants::ElevatorThreshold;}).ToPtr(),
  ...
  frc2::CommandPtr ElevatorMovements::ScoreHybrid(subsystem_Elevator* Elevator, subsystem_Wrist* Wrist, subsystem_Intake* Intake, subsystem_LED* LED){
    return frc2::cmd::Sequence(command_MoveElevator(Elevator, [=]{return ElevatorConstants::kElevatorScoreHybrid;}, [=]{return false;}, [=]{return ElevatorConstants::ElevatorThreshold;}).ToPtr(),
  ...
  frc2::CommandPtr ElevatorMovements::ToStow(subsystem_Elevator* Elevator, subsystem_Wrist* Wrist, subsystem_Intake* Intake, subsystem_LED* LED){
    return frc2::cmd::Sequence(command_MoveElevator(Elevator, [=]{return ElevatorConstants::kElevatorStow;}, [=]{return false;}, [=]{return ElevatorConstants::ElevatorThreshold;}).ToPtr(),
                                Wrist->ZeroWrist());
  }
  ...
  frc2::CommandPtr ElevatorMovements::DoubleSubstationIntake(subsystem_Elevator* Elevator, subsystem_Wrist* Wrist, subsystem_Intake* Intake, subsystem_LED* LED){
    return frc2::cmd::Sequence(command_MoveElevator(Elevator, [=]{return ElevatorConstants::kElevatorIntakeDoubleSubstation;}, [=]{return false;}, [=]{return ElevatorConstants::ElevatorThreshold;}).ToPtr(),
