...
namespace ElevatorConstants
{
    ...
    constexpr double kElevatorScoreMidCube = 24.951/4;
    constexpr double kElevatorScoreMidCone = 24.951/4;
    constexpr double kElevatorScoreHighCube = 44.265/4;
    constexpr double kElevatorScoreHighCone = 53.697/4;
    ...
    constexpr double kUpElevatorP = 0.1;
    constexpr double kUpElevatorI = 0;
    constexpr double kUpElevatorD = 0.0005;

    constexpr double kDownElevatorP = 0.01;
    constexpr double kDownElevatorI = 0;
    constexpr double kDownElevatorD = 0.0005;

    constexpr double kUpElevatorSlot = 0;
    constexpr double kDownElevatorSlot = 1;
